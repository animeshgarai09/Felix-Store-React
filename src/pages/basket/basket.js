...
const Basket = () => {
    ...
    const { BasketState, removeFromBasket, removeAllFromBasket } = useBasket()
                ...
                : <div className={styles.wrapper}>
                    <div className={styles.item_container}>
                        <div className={styles.info}>
                            ...
                            <Button size="sm" variant="ghost" onClick={handleRemoveAll} isRound={true} isTransform={false} theme="danger">Remove all</Button>
                        </div>
